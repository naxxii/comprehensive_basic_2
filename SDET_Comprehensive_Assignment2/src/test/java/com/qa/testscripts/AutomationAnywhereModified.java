...
public class AutomationAnywhereModified {
    ...
    public void testProductLink() {
        ...
        Assert.assertTrue(productLink.isDisplayed(), "Product link is not getting displayed");
        productLink.click();
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.automationanywhere.com/products",
                "Product link/ hyperlink is not being navigated to the correct URL");
    }
    ...
    public void testSolutionsLink() {
        ...
        Assert.assertTrue(solutionsLink.isDisplayed(), "Solutions link is not being displayed");
        ...
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.automationanywhere.com/solutions",
                "Solutions link is not being navigated to the correct URL");
    }
    ...
    public void testResourcesLink() {
        ...
        Assert.assertTrue(resourcesLink.isDisplayed(), "Resources link is not being displayed");
        Actions actions = new Actions(driver);
        ...
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.automationanywhere.com/resources",
                "Resources link is not being navigated to the correct URL");
    }
    ...
    public void testBeyondRPALink() {
        ...
        Assert.assertTrue(beyondRPALink.isDisplayed(), "BeyondRPA link is not being displayed");
        Actions actions = new Actions(driver);
        ...
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.automationanywhere.com/rpa/robotic-process-automation",
                "BeyondRPA link/ Portal  is not being navigated to the correct URL");
    }
    ...
    public void testCompanyLink() {
        ...
        Assert.assertTrue(companyLink.isDisplayed(), "Company Portal link is not being displayed");
        Actions actions = new Actions(driver);
        ...
        Assert.assertEquals(driver.getCurrentUrl(), "https://www.automationanywhere.com/company/about-us",
                "Company Portal link is not being navigated to the correct URL");
    }
